  ...
  return (
    <>
      <div className='container' style={{color:props.mode==='dark'?'white':'#042743'}}>
        ...
        <div className='mb-3'>
          <textarea className="form-control" value={text} onChange={handleOnChange} style={{background:props.mode==='dark'?'#2a3773':'white', color:props.mode==='dark'?'white':'042743'}} id="myBox" rows="8"></textarea>
        </div>
        ...
        <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleClearClick}>Clear Taxt</button >
